...
"Mpsy_parent_ignorer_item1"

```{r}
vec <- c("mpsy_parent_demotiver_sport",
...
```{r}
vec <- c("mpsy_parent_normalisation","mpsy_parent_necessaire_perf",  # ...TOUT[238]
...
```{r}
vec <- c("Mpsy_parent_consideration_normal",   # 252-254 = 281-283 = TOUT[250-252]
         "mpsy_parent_necessaire_perf_2","Mpsy_parent_partie_compet")
Qu3nouv(PSY, vec)
```

```{r}
vec <- c(          # 255,- = 284-293 = TOUT[253]
