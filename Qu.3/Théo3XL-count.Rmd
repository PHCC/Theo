...
```{r}
vec <- c( "mpsy_adulte_demotive_sport","Mpsy_adulte_moins_perf","mpsy_adulte_perdu_confiance_2",  # TOUT[202-213]
...
Les deux avec seulement 1 interprétation et 1 conséquence
