...
MPS$PaireCat1_Interpretations <- rowSums(MPS[,vec],na.rm=T)  
...
trier <- function(df, names) {
  sm <- function(x){return(sum(df[x],na.rm=T))}

  namedList <- lapply(names,sm)
...
MPS$PaireCat1_Consequences <- rowSums(MPS[vec],na.rm=T)
...
MPS$Adult1_Consequences <- rowSums(MPS[,vec],na.rm=T)
...
En fait, toutes les valeurs sont NA! par la summation en négligeant les NA, toutes les valeurs deviennent 0.
...
MPS$Parents1_Consequences <- rowSums(MPS[,vec],na.rm=T)
...
PSY$PairCat1_Interpretations <- rowSums(PSY[,vec],na.rm=T)
...
PSY$PairCat1_Consequences <- rowSums(PSY[,vec],na.rm=T )
...
PSY$PairCat2_Consequences <- rowSums(PSY[,vec],na.rm=T )
...
PSY$PairCat3_Interpretations <- rowSums(PSY[,vec],na.rm=T)
...
PSY$PairCat3_Consequences <- rowSums(PSY[,vec],na.rm=T)
...
PSY$PairCat4_Consequences <- rowSums(PSY[,vec],na.rm=T)
...
PSY$AdultCat1_Interpretations <- rowSums(PSY[,vec],na.rm=T) 
...
PSY$AdultCat1_Consequences <- rowSums(PSY[,vec],na.rm=T)
...
PSY$AdultCat2_Interpretations <- rowSums(PSY[,vec],na.rm=T)
...
PSY$AdultCat2_Consequences <- rowSums(PSY[,vec],na.rm=T)
...
PSY$AdultCat3_Interpretations <- rowSums(PSY[,vec],na.rm=T)
descriptives(PSY, "AdultCat3_Interpretations",freq=TRUE)
trier(PSY,vec)
```
...
PSY$AdultCat3_Consequences <- rowSums(PSY[,vec],na.rm=T)
...
PSY$AdultCat4_Interpretations <- rowSums(PSY[,vec],na.rm=T)
...
vec <- c( "mpsy_adulte_demotive_sport","Mpsy_adulte_moins_perf","mpsy_adulte_perdu_confiance_2", # 206-215 = 218-227
     ...
     "Mpsy_adulte_humiliation")
PSY$AdultCat4_Consequences <- rowSums(PSY[,vec],na.rm=T)
...
PSY$ParentCat1_Interpretations <- rowSums(PSY[,vec],na.rm=T)  
...
PSY$ParentCat1_Consequences <- rowSums(PSY[,vec],na.rm=T)  
...
PSY$ParentCat2_Interpretations <- rowSums(PSY[,vec],na.rm=T)
...
PSY$ParentCat2_Consequences <- rowSums(PSY[,vec],na.rm=T)
...
PSY$ParentCat3_Interpretations <- rowSums(PSY[,vec],na.rm=T)  
...
PSY$ParentCat3_Consequences <- rowSums(PSY[,vec],na.rm=T )  
...
PSY$ParentCat4_Interpretations <- rowSums(PSY[,vec],na.rm=T)  
...
PSY$ParentCat4_Consequences <- rowSums(PSY[,vec],na.rm=T )  
...
SEX$PaireCat1_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$PaireCat1_Consequences <- rowSums(SEX[,vec],
                                      na.rm=T )
...
SEX$PaireCat2_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$PaireCat2_Consequences <- rowSums(SEX[,vec],na.rm=T )
...
SEX$PaireCat3_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$PaireCat3_Consequences <- rowSums(SEX[,vec],na.rm=T )
...
SEX$PaireCat4_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$PaireCat4_Consequences <- rowSums(SEX[,vec],na.rm=T )
...
SEX$PaireCat5_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$PaireCat5_Consequences <- rowSums(SEX[,vec] ,na.rm=T)
...
SEX$PaireCat6_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$PaireCat6_Consequences <- rowSums(SEX[,vec],na.rm=T )
...
SEX$PaireCat7_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$PaireCat7_Consequences <- rowSums(SEX[,vec],na.rm=T )
...
SEX$AdultCat1_Interpretations <- as.numeric( rowSums(SEX[,vec],na.rm=T) )
...
SEX$AdultCat1_Consequences <- rowSums(SEX[,vec],na.rm=T )
descriptives(SEX, "PaireCat1_Consequences",freq=FALSE)
...
SEX$AdultCat2_Interpretations <- rowSums(SEX[,vec],na.rm=T)
descriptives(SEX, "PaireCat2_Interpretations",freq=FALSE)
...
SEX$AdultCat2_Consequences <- rowSums(SEX[,vec],na.rm=T )
descriptives(SEX, "PaireCat2_Consequences",freq=FALSE)
...
SEX$AdultCat3_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$AdultCat3_Consequences <- rowSums(SEX[,vec],na.rm=T )
descriptives(SEX, "PaireCat3_Consequences",freq=FALSE)
...
SEX$AdultCat4_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$AdultCat4_Consequences <- rowSums(SEX[,vec],na.rm=T )
...
SEX$AdultCat5_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
SEX$AdultCat5_Consequences <- rowSums(SEX[,vec],na.rm=T )
...
SEX$AdultCat6_Interpretations <- rowSums(SEX[,vec],na.rm=T)
...
```{r}
SEX$AdultCat6_Consequences <- rowSums(SEX[,c(  # ..412..416.. = 513-522
...
NEG$AdultCat1_Interpretations <- rowSums(NEG[,vec],na.rm=T)
...
NEG$AdultCat1_Consequences <- rowSums(NEG[,vec],na.rm=T)
...
NEG$AdultCat2_Interpretations <- rowSums(NEG[,vec],na.rm=T)
...
NEG$AdultCat2_Consequences <- rowSums(NEG[,vec],na.rm=T )
...
NEG$AdultCat3_Interpretations <- rowSums(NEG[,vec],na.rm=T)
...
NEG$AdultCat3_Consequences <- rowSums(NEG[,vec],na.rm=T )
...
NEG$ParentCat1_Interpretations <- rowSums(NEG[,vec],na.rm=T)
...
NEG$ParentCat1_Consequences <- rowSums(NEG[,vec],na.rm=T )
...
NEG$ParentCat2_Interpretations <- rowSums(NEG[,vec],na.rm=T)
...
NEG$ParentCat2_Consequences <- rowSums(NEG[,vec],na.rm=T)
...
NEG$ParentCat3_Interpretations <- rowSums(NEG[,vec],na.rm=T)
...
NEG$ParentCat3_Consequences <- rowSums(NEG[,c(vec)],na.rm=T )
