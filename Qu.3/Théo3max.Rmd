...
MPS$Adult1_Interpretations <- rowMaxs(as.matrix(MPS[,vec],na.rm=T))
...
MPS$Parents1_Interpretations <- 
  rowMaxs(as.matrix(MPS[,vec],na.rm=T))
...
PSY$PairCat1_Interpretations <- rowMaxs(as.matrix(PSY[,vec]),na.rm=T)
...
PSY$PairCat1_Consequences <- rowMaxs(as.matrix(PSY[,vec],na.rm=T )
...
PSY$PairCat2_Interpretations <- 
  rowMaxs(as.matrix(PSY[,vec],na.rm=T))
...
SEX$PaireCat1_Consequences <- rowMaxs(as.matrix(SEX[,vec],
                                      na.rm=T )
